...
let locationTypes = [
	...
	new LocationType("Runic Book", '"', `A large book sitting open on a pedestal.  It has 4 pages, each with a different rune more complicated than the last.`, "Walk", "Read", null),
