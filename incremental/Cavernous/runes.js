...
let runes = [
	...
	new Rune("Duplication", "D", 75, () => true, 1000, "Mine more resources with this rune.  After placing it, interact with it to charge it up.  You'll receive +0.1 of each adjacent resource (when mined) per charge, though each charge is harder than the last.<br>Requires:<br>Runic Lore 75", null, "Charge Duplication"),
];
