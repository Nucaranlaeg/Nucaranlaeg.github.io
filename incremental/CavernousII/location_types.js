...
let locationTypes = [
	...
	new LocationType("Anvil - Bridge", "⎶", "An anvil on which you can make a bridge out of 2 iron bars.", "Walk", "Create Bridge", null),
	new LocationType("Anvil - Long Bridge", "║", "An anvil on which you can make a bridge out of 2 iron bars.  These pits are a bit wider than the others, so it'll take a bit longer to craft the bridge (though your old ones still work for some reason).", "Walk", "Create Long Bridge", null),
	new LocationType("Anvil - Sword", ")", "An anvil on which you can make a sword out of 3 iron bars.", "Walk", "Create Sword", null),
	new LocationType("Anvil - Shield", "[", "An anvil on which you can make a shield out of 5 iron bars.", "Walk", "Create Shield", null),
	new LocationType("Anvil - Armour", "]", "An anvil on which you can make a suit of armour out of 4 iron bars.", "Walk", "Create Armour", null),
	...
	new LocationType("Mushroom", "♠", "A giant mushroom which grows quickly.  It's harder to cut the longer you wait. (Growth: 1+0.1t)", "Chop", null, null),
	new LocationType("Kudzushroom", "♣", "A giant mushroom which grows quickly.  It grows so fast each clone needs to make its own way every time. (Growth: 1+0.1t)", "Kudzu Chop", null, null, null, Infinity),
	new LocationType("Sporeshroom", "α", "A giant mushroom which grows quickly.  While you cut it, it lets out poisonous spores, injuring your clones. (Growth: 1+0.1t)", "Spore Chop", null, null),
	new LocationType("Oystershroom", "§", "A giant mushroom which grows extremely quickly.  You don't think you've ever seen a mushroom grow that fast. (Growth: 1+0.2t)", "Oyster Chop", null, null),
