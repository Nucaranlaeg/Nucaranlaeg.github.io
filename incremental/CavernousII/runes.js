...
let runes = [
	...
	new Rune("Duplication", "D", () => true, 1000, "Mine more resources with this rune.  After placing it, interact with it to charge it up.  You'll receive +1 of each (orthogonally or diagonally) adjacent resource (when mined), though each rune placed makes it harder to charge others.", null, "Charge Duplication"),
];
