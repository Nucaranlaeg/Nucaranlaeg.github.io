...
let runes = [
	...
	new Rune("Wither", "H", simpleRequire([["Salt", 1], ["Iron Ore", 1], ["Gold Nugget", 1]]), 0, "This rune allows you to kill any orthogonally adjacent plants.  Interact with it to charge it up - it takes as much time to charge as the plants you're trying to kill would take to chop.<br>Requires:<br>{'0':'1 Salt<br>1 Iron Ore<br>1 Gold Nugget','1':'2 Salt<br>2 Iron Ore<br>2 Gold Nuggets'}", null, "Charge Wither"),
